  ...
  return (
    <div className="bg-black text-white py-16 px-8 font-raleway">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <form>
            ...
            <label className="block mb-4">
              ...
              <div className=" text-gray-500 flex flex-wrap gap-2 mt-2">
                {['User Experience', 'User Interface', 'Service Design', 'Design System', 'User Test'].map((interest, index) => (
        ...
        <div className="bg-black text-white rounded-lg p-8 shadow-lg font-raleway">
