...
import digitalMarketing from '../assets/digimark.png';
...
const Services = () => {
  return (
    <div style={{ backgroundImage: `url(${bgimg})`, backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '100vh' }}>
      <div className=" text-white py-16 px-4 sm:px-8 font-raleway">
        <div className="container mx-auto flex flex-col items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
            {[
              ...
              { title: "Digital Marketing", img: digitalMarketing, desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Proin ut tortor vel orci varius gravida." },
            ].map((service, index) => (
              <div key={index} className="flex flex-col items-center md:items-start">
                <div className="w-full mb-4 max-w-xs transition-transform transform hover:scale-105">
                  <img src={service.img} alt={service.title} className="w-500 h-250  rounded-lg shadow-lg" />
                </div>
                <div className="text-center md:text-left">
                  <h3><div className='inline-block w-4 h-4 bg-violet-700 rounded-full mr-2'></div>{service.title}</h3>
